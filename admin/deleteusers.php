    ...
    <div style="margin-top:50px;margin-bottom:100px;">
        ...
        <select style="width:100%;min-height:50%;" id="sbOne" multiple="multiple">
          <?php
            ...
            $getUsers = pg_query("select username, category from user_account where deleted=false;");
		...
		<div class="col-md-5">
		<form action="submitDeleteUsers.php" method="post">
        <select name="list[]" style="width:100%;min-height:50%;" id="sbTwo" multiple="multiple">
        </select>
        <button style="width:100%;" type="submit" class="btn btn-default" id="left" value="<">DELETE</button>
        </form>
